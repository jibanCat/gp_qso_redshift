...
class GPLoaderZ(object):
    '''
    Class to store parameters of our GP model
    '''

    def __init__(self, rest_wavelengths, mu, M):
        self.rest_wavelengths = rest_wavelengths
        self.mu = mu
        self.M  = M
        # self.log_tau_0 = log_tau_0
...
class QSOLoader(object):
    '''
    A Base class to read preloaded QSO spectroscopic data, D = {λ, y},
    '''
    def __init__(self, preloaded_file="preloaded_qsos.mat", catalogue_file="catalog.mat", 
            ...
            sub_dla=True, sample_file="dla_samples.mat", occams_razor=False):
    ...
    def plot_this_mu(self, nspec, suppressed=True, num_voigt_lines=3, num_forest_lines=31, 
...
class QSOLoaderZ(QSOLoader):
    ...
    def __init__(self, preloaded_file="preloaded_qsos.mat", catalogue_file="catalog.mat", 
        ...
        self.z_true = self.z_qsos[:len(self.z_map)]
    ...
    def plot_z_sample_posteriors(self, nspec, dla_samples=False):
        ...
        this_sample_log_posteriors = self.sample_log_posteriors[:, nspec_nan]
        ...
        non_inf_ind = ~np.isinf( this_sample_log_posteriors )
